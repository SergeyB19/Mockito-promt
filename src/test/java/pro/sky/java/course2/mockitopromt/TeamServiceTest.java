package pro.sky.java.course2.mockitopromt;
...
import pro.sky.java.course2.mockitopromt.exception.TeamExistsException;
import pro.sky.java.course2.mockitopromt.exception.TeamNotExistException;
import pro.sky.java.course2.mockitopromt.repository.TeamRepository;
import pro.sky.java.course2.mockitopromt.service.TeamServiceImpl;
...
import static pro.sky.java.course2.mockitopromt.constans.TeamConstans.*;


@ExtendWith(MockitoExtension.class)
class TeamServiceImplTest {

    private static final String TEAM_NAME_1 = "Team 1";
    private static final Collection<String> TEAM_LIST = List.of(
            TEAM_NAME_1,
            TEAM_NAME_2,
            TEAM_NAME_3,
            TEAM_NAME_4
    ); ;
    private static final String GOOD_PREFIX = "Tea";
    private static final String BAD_PREFIX = "ABC" ;
    @Mock
